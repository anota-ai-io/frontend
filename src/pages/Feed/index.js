        ...
        {!this.loading &&
          <>
            <div className="h-screen w-screen grid grid-cols-1 md:grid-cols-7 overflow-hidden">
              ...
              <div className={this.state.menuMobileState ? "col-span-1 animacao-padrao" : "hidden md:grid col-span-2 border-t-4"}>
      
                <div className="flex flex-row justify-between md:row-span-1 md:block md:p-5">
                  <img src={Logo} className="" />
                  <img src={xClose} className={this.state.menuMobileState ? "block mr-5" : "hidden " } width={25} height={25} onClick={e => this.setMenuMobile()}/>
                </div>
              ...
              <div  
                className={this.state.menuMobileState ? "hidden" : "col-span-1 md:col-span-3 border-t-4 border-2 h-screen overflow-y-scroll animacao-padrao"}>
